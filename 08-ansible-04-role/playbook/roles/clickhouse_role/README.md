# THIS DESCRIPTION REGARDS USING CONFIGURATION FILES [config.j2](./templates/config.j2) and [users.j2](./templates/users.j2)!

#### Now files [config.xml.j2](./templates/config.j2) and [users.xml.j2](./templates/users.j2) applied.
